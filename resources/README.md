...
Allen AI dog whistle glossary. The glossary is shipped here as a local
markdown dump (`Glossary_of_Dogwhistles.md`), and `extract_definitions.py`
parses that markdown directly into the structured CSVs that downstream tasks
use as their definition source.
...
The two model variants for RQ-A's definition ablation are:
